const movies= [
  ...
  let dom_continer=document.querySelector(".dom_container");
  ...
  let showData=(movies)=>{
    dom_continer.innerHTML=movies.map((Movie)=>`
  <div class="main">
  ...
  action.addEventListener('click',()=>{
    let newMovies=movies.filter((Movie)=>Movie.category==='Action');
    showData(newMovies)
  })
  triller.addEventListener('click',()=>{
    let newMovies=movies.filter((Movie)=>Movie.category==='Thriller');
    showData(newMovies)
  })
  animation.addEventListener('click',()=>{
    let newMovies=movies.filter((Movie)=>Movie.category==='Animation');
    showData(newMovies)
  })
  action.addEventListener('click',()=>{
    let newMovies=movies.filter((Movie)=>Movie.category==='Action');
  ...
  horror.addEventListener('click',()=>{
    let newMovies=movies.filter((Movie)=>Movie.category==='Horror');
    showData(newMovies)
  })
  drama.addEventListener('click',()=>{
    let newMovies=movies.filter((Movie)=>Movie.category==='Drama');
    showData(newMovies)
  })
  sci_fi.addEventListener('click',()=>{
    let newMovies=movies.filter((Movie)=>Movie.category==='Sci-Fi');
    showData(newMovies)
  })
